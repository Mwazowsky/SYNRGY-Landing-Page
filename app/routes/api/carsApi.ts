...
class CarsApi {
    ...
    routes() {
        ...
        */
        this.router.get("/healthcheck", CarsController.healthCheck);
        ...
        */
        ...
        this.router.put('/:car_id',
            ...
            UploadMiddleware.handleUpload,
            AuthMiddleware.authorizeAdmin,
            CarsController.update); // /api/books/1 -> /api/books/:car_id UPDATE
        this.router.delete('/:car_id',
            AuthMiddleware.authorizeAdmin,
            CarsController.delete); // /api/books/1 -> /api/books/:id DELETE
